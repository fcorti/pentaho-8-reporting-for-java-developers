...
public class PentahoServlet extends HttpServlet 
{
    ...
    throws ServletException, IOException 
  {
    ...
    try {
      ...
      chartExpression.setSeriesColor( new String[] {"#abcd37","#0392ce","#f9bc02","#66b033","#cc0099"} );
      ...
      chartElement.setAttributeExpression(AttributeNames.Core.NAMESPACE, AttributeNames.Core.VALUE, chartExpression);
      chartElement.setAttribute(LegacyChartElementModule.NAMESPACE,
      LegacyChartElementModule.PRIMARY_DATA_COLLECTOR_FUNCTION_ATTRIBUTE, collector);
      ...
      // Creating a label for product name and add it to the header.
      LabelElementFactory labelFactory = new LabelElementFactory();
      labelFactory.setText("Product");
      labelFactory.setX(1f);
      labelFactory.setY(250f);
      labelFactory.setMinimumWidth(100f);
      labelFactory.setMinimumHeight(20f);
      labelFactory.setBold(true);
      Element label1 = labelFactory.createElement();
      reportHeader.addElement(label1);

      // Creating a label for product total cost and add it to the header.
      labelFactory.setText("Total cost");
      labelFactory.setX(101f);
      labelFactory.setY(250f);
      labelFactory.setMinimumWidth(100f);
      labelFactory.setMinimumHeight(20f);
      labelFactory.setBold(true);
      Element label2 = labelFactory.createElement();
      reportHeader.addElement(label2);

      // Adding a text field for the product, added to the item band.
      ...
      numberFactory.setFieldname("totalCostPerProduct");
