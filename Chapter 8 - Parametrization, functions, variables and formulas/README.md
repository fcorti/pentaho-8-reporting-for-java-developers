Parametrization, functions, variables and formulas
===

This folder contains the Pentaho reports developed in Chapter 8 about parametrization, functions, variables, formulas. To edit (and preview) the reports use the Pentaho Report Designer or any other Pentaho Reporting tool able to manage `prpt` files.
