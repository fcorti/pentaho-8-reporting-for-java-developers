...
This folder contains the Pentaho reports developed in Chapter 10 about sub-reports and cross tabs. To edit (and preview) the reports use the Pentaho Report Designer or any other Pentaho Reporting tool able to manage `prpt` files.
