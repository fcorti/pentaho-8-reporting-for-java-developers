...
This folder contains the Pentaho reports developed in Chapter 14 about building interactive reports. The folder contains maven projects developing a web application enabling the preview of Pentaho reports.
